...
% Must be loaded after polyglossia
\usepackage{biblatex}
...
\input{sections/vqvae.tex}
\input{sections/gan.tex}
\input{sections/vqgan.tex}

% Diffusion models
\input{sections/diffusion_models.tex}
\input{sections/stable_diffusion.tex}
...
% Previous works
\input{sections/videogpt.tex}

% Main works
\input{sections/video_ldm.tex}
\input{sections/imagen_video.tex}
\input{sections/make_a_video.tex}
...
% Hebrew sections
\include{sections/hebrew/table_of_contents}
\include{sections/hebrew/conclusion}
\include{sections/hebrew/cover}
