...
where the first term is the reconstruction loss and the second term is the KL divergence (which measure how much the approximate posterior $q_\phi (z|x)$ diverges from the prior $p(z)$). 