...
\begin{figure}
    ...
    \caption{SR3 16x16 $\rightarrow$ 128x128 upsampling. where $x$ is the input image, upscaled to the target resolution using bicubic interpolation, and then its concatenated with the noise $y$.}
